                    ...
                    <tr>
                        <td valign="top">
							...
							<form method="get" id="randomnames">
								...
								<table class="tborder" cellspacing="5" cellpadding="5" style="width: 90%;">
									<tr>
										<td class="tcat" width="25%">{$lang->randomnames_type}</td>
										<td class="tcat" width="25%">{$lang->randomnames_gender}</td>
										<td class="tcat" width="25%">{$lang->randomnames_letter}</td>
										<td class="tcat" width="25%">{$lang->randomnames_num}</td>
									</tr>	
									<tr>
									...
									<tr>
										<td colspan="4" class="trow2" align="center">
							...
							<br ><br />
							<center>
								<span style="font-size: 22px;">{$randomname}</span>
							</center>
                        </td>
                    </tr>
                </table>
...
function randomnames_misc() 
{
	...
	for($i = 1; $i <= $num; $i++) {
		$namesIndex = array_rand($names);
        	$randomnames[] = $names[$namesIndex];
	}
		
	foreach($randomnames as $key => $name) {
		$randomname .= $name." ".$randomlastname[$key]."<br />";
	}
